...
@section('title', 'Tambah Data Lengkap Mahasiswa')

@section('content')
    <div class="card-body p-4">
        <h3 class="title-page mb-4">Tambah Data Lengkap Mahasiswa</h3>

        <form action="{{ route('data-lengkap-mahasiswa.store') }}" method="POST">
            @csrf
                    ...
                    <div class="mb-3">
                        ...
                        <select id="nim_mahasiswa" name="nim_mahasiswa"
                            ...
                            @foreach($dataMahasiswa as $mahasiswa)
                                <option value="{{ $mahasiswa->NIM }}" {{ old('nim_mahasiswa') == $mahasiswa->NIM ? 'selected' : '' }}>
                    ...
                    <div class="mb-3">
                        ...
                        <select id="matkul" name="matkul"
                            ...
                            @foreach($dataMataKuliah as $mataKuliah)
                                <option value="{{ $mataKuliah->kode_matkul }}" {{ old('matkul') == $mataKuliah->kode_matkul ? 'selected' : '' }}>
            ...
            <div class="mb-3">
                ...
                <select id="tahun_akademik_id" name="tahun_akademik_id"
                    ...
                    @foreach($dataTahunAkademik as $tahunAkademik)
                        <option value="{{ $tahunAkademik->id }}" {{ old('tahun_akademik_id') == $tahunAkademik->id ? 'selected' : '' }}>
