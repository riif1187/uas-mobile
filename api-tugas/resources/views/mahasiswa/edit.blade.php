...
@section('content')
    <div class="card-body p-4">
        <h3 class="title-page mb-4">Edit Data Mahasiswa</h3>
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <input type="text" id="kewarganegaraan" name="kewarganegaraan"
                            ...
                            value="{{ old('kewarganegaraan', $mahasiswa->kewarganegaraan) }}">
                    ...
                    <div class="mb-3">
                        ...
                        <select id="status_pernikahan" name="status_pernikahan"
                            ...
                            @foreach(['Belum Menikah','Menikah','Cerai'] as $status)
                                <option value="{{ $status }}" {{ old('status_pernikahan', $mahasiswa->status_pernikahan) == $status ? 'selected' : '' }}>{{ $status }}</option>
                            @endforeach
                        </select>
